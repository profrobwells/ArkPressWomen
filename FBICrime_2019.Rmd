...
<br>
<br>
Learning Outcome: Journalists will learn to build basic data visualizations and maps for their own cities or regions and the steps to put it on a basic map and an interactive chart. We will use Tableau Public.
...
> [Data Declaration: "CNTL" + click for a New Tab](https://ucr.fbi.gov/crime-in-the-u.s/2017/crime-in-the-u.s.-2017/tables/table-8/table-8-data-declaration){target="_blank"}
...
<img src="Images/UARK Logo vert NEW copy.jpg" width="100" height="100" />
